...
def _to_sequence_example(image_id, image_filename, image_captions, decoder, vocab):
...
def _process_dataset(image_metadata, vocab):
    ...
    strings = []
    counter = 0
    for image_id, filename, captions in image_metadata:
        sequence_example = _to_sequence_example(image_id, filename, captions, decoder, vocab)
...
def _load_and_process_metadata(input_file, image_dir):
    ...
    for image_id in image_ids:
        ...
        image_metadata.append((image_id, filename, captions))
