...
TFRECORD_DIR="${DIR}/data/Ranker_TFRecord_data_v3/16cc3182342295279d1a71a54367d87de31e1f05"
MODEL_DIR="${DIR}/model"
image_model=InceptionV3Model
text_model=LstmModel
match_model=CosModel

model_dir_name=ranker_v3_pairwise_baseline_sigmoid_model
...
cd ranker && CUDA_VISIBLE_DEVICES=${device} python train.py \
  ...
  --number_of_steps=200000 # 20 epochs
