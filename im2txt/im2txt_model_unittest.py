...
"""Tests for tensorflow_models.im2txt.im2txt_model."""
...
class Im2TxtModel(im2txt_model.Im2TxtModel):
  """Subclass of Im2TxtModel without the disk I/O."""

  def build_inputs(self):
    if self.mode == "inference":
      # Inference mode doesn't read from disk, so defer to parent.
      return super(Im2TxtModel, self).build_inputs()
    else:
...
class Im2TxtModelTest(tf.test.TestCase):

  def setUp(self):
    super(Im2TxtModelTest, self).setUp()
